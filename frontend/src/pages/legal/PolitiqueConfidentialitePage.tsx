      ...
      <div className="prose prose-gray max-w-none space-y-6 text-sm">
        <section>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <p>Email : <a href="mailto:dpo@poutscent.bj" className="text-purple-600">dpo@poutscent.bj</a></p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-900">4. Destinataires des données</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-900">5. Transfert de données hors du Bénin</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-900">7. Sécurité des données</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-gray-900">8. Violation de données</h2>
          <p>
