...
export function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t-2 border-purple-600 shadow-2xl">
      <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button
                ...
                className="px-6 py-2 border border-purple-600 text-purple-600 rounded-lg font-medium hover:bg-purple-50 transition-colors flex items-center gap-2"
              >
          ...
          <>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex items-start gap-3">
                ...
                />
                <div>
                  <label htmlFor="cookie-necessary" className="font-medium text-gray-900">
              ...
              <div className="flex items-start gap-3">
                ...
                />
                <div>
                  <label htmlFor="cookie-marketing" className="font-medium text-gray-900">
                    Cookies marketing
                  </label>
                  <p className="text-sm text-gray-600">
        ...
        <p className="text-xs text-gray-500 mt-4">
          ...
          <a href="/politique-cookies" className="text-purple-600 hover:underline">
