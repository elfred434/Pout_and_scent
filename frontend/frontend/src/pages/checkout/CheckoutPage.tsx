    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
        ...
        <div className="space-y-3">
          {items.map((item) => (
            <div key={item.variante_id} className="flex justify-between items-center py-2 border-b border-neutral-100 last:border-0">
              <div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
        ...
        <textarea
          ...
          maxLength={500}
        />
        <p className="text-xs text-neutral-500 mt-1">{notes.length}/500 caractères</p>
      </div>
