        ...
        <div className="text-center space-y-6 px-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-body text-neutral-600 dark:text-neutral-400 max-w-md mx-auto">
              Découvrez notre collection et trouvez le parfum parfait pour vous
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              {items.map((item) => (
                <div key={item.variante_id} className="card-static dark:bg-neutral-900 dark:border-neutral-700 p-4 sm:p-6">
            ...
            <div className="lg:col-span-1">
              <div className="card-static dark:bg-neutral-900 dark:border-neutral-700 p-6 space-y-6 sticky top-24">
                <h2 className="text-title text-neutral-900 dark:text-white">Résumé de la commande</h2>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-neutral-900 dark:text-white">À définir</span>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-display text-neutral-900 dark:text-white">
              Produits <span className="text-primary-600">recommandés</span>
            </h2>
          </div>
