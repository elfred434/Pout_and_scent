...
export function CGVPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-neutral-900 mb-2">Conditions Générales de Vente</h1>
      ...
      <div className="prose prose-gray max-w-none space-y-6 text-sm">
        <section>
          <h2 className="text-lg font-semibold text-neutral-900">Article 1 — Objet et champ d'application</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-900">Article 2 — Identification du Vendeur</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-900">Article 3 — Produits</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-900">Article 4 — Prix</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-900">Article 5 — Commande (Double confirmation)</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-900">Article 6 — Paiement</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-900">Article 7 — Livraison</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-900">Article 8 — Droit de rétractation</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-900">Article 9 — Garantie légale de conformité</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-900">Article 10 — Annulation et expiration</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-900">Article 11 — Signalement d'effets indésirables</h2>
          <p>
            ...
            <Link to="/signalement" className="text-primary-600 hover:underline">formulaire de signalement</Link>{' '}
            ou directement à l'ABMed au <strong>01 51 20 98 15</strong>.
          </p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-neutral-900">Article 12 — Protection des données personnelles</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-900">Article 13 — Médiation et litiges</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-900">Article 14 — Droit applicable</h2>
          <p>
