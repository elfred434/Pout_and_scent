  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none space-y-8">
        <section>
          <h2 className="text-xl font-semibold text-neutral-900 mb-3">1. Éditeur du site</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral-900 mb-3">2. Hébergeur</h2>
          <div className="bg-neutral-50 p-4 rounded-lg">
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral-900 mb-3">3. Propriété intellectuelle</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral-900 mb-3">4. Protection des données personnelles</h2>
          <p>
          ...
          <p>
            ...
            <a href="mailto:dpo@poutscent.bj" className="text-primary-600 hover:underline">dpo@poutscent.bj</a>.
          </p>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral-900 mb-3">6. Droit applicable et juridiction</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-neutral-900 mb-3">7. Réglementation cosmétiques</h2>
          <p>
          ...
          <p>
            ...
            <Link to="/signalement" className="text-primary-600 hover:underline">
