            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="text-display-lg md:text-display-xl text-neutral-900 text-balance">
                  L'art du parfum,{' '}
                  <span className="text-primary-600">redéfini.</span>
                </h1>
                <p className="text-subtitle text-neutral-600 max-w-lg leading-relaxed">
                  Découvrez notre sélection exclusive de parfums et cosmétiques de qualité,
                  livrés partout au Bénin.
                </p>
              </div>
      ...
      <section className="py-20 lg:py-24 bg-white dark:bg-neutral-900">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="relative aspect-square overflow-hidden rounded-2xl border border-primary-100 bg-gradient-to-br from-primary-50 via-white to-accent-50 dark:border-primary-900 dark:from-primary-950/40 dark:via-neutral-900 dark:to-accent-900/20">
              <div className="absolute -left-16 -top-16 h-52 w-52 rounded-full bg-primary-200/60 blur-3xl dark:bg-primary-800/30" />
              <div className="absolute -bottom-16 -right-16 h-52 w-52 rounded-full bg-accent-200/70 blur-3xl dark:bg-accent-800/30" />
              <div className="relative flex h-full items-center justify-center p-12">
                <img src={logoIcon} alt="Pout & Scent" className="w-2/5 max-w-40 drop-shadow-lg" />
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-display text-neutral-900 text-balance">
                Qualité <span className="text-primary-600">sans compromis</span>
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              {
                text: "Qualité irréprochable et service attentionné. Ma boutique préférée.",
                name: 'Grace M.',
              },
              {
                text: "Produits de qualité et prix très corrects. Je suis conquise.",
                name: 'Deborah A.',
              },
            ].map((testimonial, i) => (
      ...
      <section className="py-20 lg:py-24 bg-neutral-900 text-white">
        <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center space-y-6">
          ...
          <h2 className="text-display text-white">
            Restez <span className="text-accent-400">informée</span>
          </h2>
