...
function ChatPanel() {
  ...
  return (
    <div className="fixed bottom-20 right-3 z-50 h-[min(560px,calc(100dvh-6rem))] w-[calc(100vw-1.5rem)] max-w-[380px] bg-white dark:bg-neutral-900 rounded-2xl shadow-2xl
      sm:bottom-24 sm:right-6 flex flex-col overflow-hidden border border-neutral-200 dark:border-neutral-700 animate-slide-up">
      ...
      {/* Footer */}
      <div className="px-3 py-2 bg-neutral-50 dark:bg-neutral-800 border-t border-neutral-200 dark:border-neutral-700 text-center">
    ...
    <div className="h-full overflow-y-auto">
      {conversations.map((conv) => (
        <button
          ...
          className="w-full px-4 py-3 border-b border-neutral-100 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors text-left"
        >
          <div className="flex items-start justify-between">
            ...
            <div className="ml-2 text-xs text-neutral-400 dark:text-neutral-500 whitespace-nowrap">
...
function ConversationView({ conversationId }: { conversationId: string }) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Messages */}
      <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-neutral-50 dark:bg-neutral-800">
        {messages.length === 0 && (
      ...
      <div className="p-3 border-t border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900">
        <div className="flex items-center gap-2">
          <input
            ...
            className="flex-1 px-4 py-2 border border-neutral-300 dark:border-neutral-600 dark:bg-neutral-800 dark:text-white dark:placeholder-neutral-500 rounded-full focus:outline-none
  ...
  if (message.type_message === 'SYSTEM') {
    return (
      <div className="text-center">
        <span className="inline-block px-3 py-1 bg-neutral-200 dark:bg-neutral-700 text-neutral-600 dark:text-neutral-400 rounded-full text-xs">
          {message.contenu}
        </span>
      </div>
    );
      ...
      <div
        className={`max-w-[80%] px-4 py-2 rounded-2xl ${
          isOwn
            ...
            : 'bg-white dark:bg-neutral-700 text-neutral-800 dark:text-white shadow-sm border border-neutral-200 dark:border-neutral-600 rounded-bl-sm'
        }`}
      >
    ...
    <form onSubmit={handleSubmit} className="flex flex-col h-full p-4">
      ...
      <div className="space-y-4 flex-1">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 dark:bg-neutral-800 dark:text-white dark:placeholder-neutral-500 rounded-xl focus:outline-none
              focus:ring-2 focus:ring-primary-500 focus:border-transparent text-sm"
            maxLength={255}
            required
          />
      ...
      <div className="flex gap-2 mt-4">
        <button
          type="button"
          onClick={onCancel}
          className="flex-1 px-4 py-2 border border-neutral-300 dark:border-neutral-600 text-neutral-700 dark:text-white rounded-xl
            hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors text-sm font-medium"
        >
          Annuler
        </button>
        <button
...
function StatusBadge({ statut }: { statut: string }) {
  const colors: Record<string, string> = {
    ...
    FERMEE: 'bg-neutral-100 text-neutral-800',
  };
